...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createMenuView() {
        ...
        let leftViewController = storyboard.instantiateViewControllerWithIdentifier("left") as LeftTableViewController
        
        let rightViewController = storyboard.instantiateViewControllerWithIdentifier("right") as RightViewController
